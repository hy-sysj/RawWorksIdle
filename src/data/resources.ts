...
export const resources = [
  ...
  { id: "desk", nameKo: "책상", emoji: "🪑", tier: "final", chain: "wood", unlockedAtStage: 1, isRaw: false },

  { id: "iron_ore", nameKo: "철광석", emoji: "⛏️", tier: "raw", chain: "iron", unlockedAtStage: 1, isRaw: true },
  { id: "pig_iron", nameKo: "선철", emoji: "⚙️", tier: "p1", chain: "iron", unlockedAtStage: 1, isRaw: false },
  { id: "steel_plate", nameKo: "강철판", emoji: "🧱", tier: "p2", chain: "iron", unlockedAtStage: 1, isRaw: false },
  { id: "steel_frame", nameKo: "철골프레임", emoji: "🏗️", tier: "part", chain: "iron", unlockedAtStage: 1, isRaw: false },
  { id: "factory_unit", nameKo: "공장설비", emoji: "🏭", tier: "final", chain: "iron", unlockedAtStage: 1, isRaw: false },
  ...
  { id: "copper_ore", nameKo: "구리광석", emoji: "🟠", tier: "raw", chain: "copper", unlockedAtStage: 2, isRaw: true },
  { id: "copper_ingot", nameKo: "동괴", emoji: "🔶", tier: "p1", chain: "copper", unlockedAtStage: 2, isRaw: false },
  { id: "copper_wire", nameKo: "구리선", emoji: "〰️", tier: "p2", chain: "copper", unlockedAtStage: 2, isRaw: false },
  { id: "wire_bundle", nameKo: "전선다발", emoji: "🪢", tier: "part", chain: "copper", unlockedAtStage: 2, isRaw: false },
  { id: "electric_unit", nameKo: "전기장치", emoji: "🔌", tier: "final", chain: "copper", unlockedAtStage: 2, isRaw: false },
  ...
  { id: "light_frame", nameKo: "경량프레임", emoji: "🛩️", tier: "part", chain: "aluminum", unlockedAtStage: 2, isRaw: false },
  ...
  { id: "microprocessor", nameKo: "마이크로프로세서", emoji: "🖥️", tier: "final", chain: "silicon", unlockedAtStage: 4, isRaw: false },
  ...
  { id: "rare_earth_ore", nameKo: "희토류광석", emoji: "🌍", tier: "raw", chain: "rare_earth", unlockedAtStage: 5, isRaw: true },
  { id: "rare_earth_oxide", nameKo: "희토류산화물", emoji: "🧬", tier: "p1", chain: "rare_earth", unlockedAtStage: 5, isRaw: false },
  { id: "neodymium_magnet", nameKo: "네오디뮴자석", emoji: "🧲", tier: "p2", chain: "rare_earth", unlockedAtStage: 5, isRaw: false },
  { id: "motor_core", nameKo: "모터코어", emoji: "⚙️", tier: "part", chain: "rare_earth", unlockedAtStage: 5, isRaw: false },
  ...
  { id: "enriched_uranium", nameKo: "농축우라늄", emoji: "☢️", tier: "p2", chain: "uranium", unlockedAtStage: 6, isRaw: false },
  ...
  { id: "iot_device", nameKo: "IoT디바이스", emoji: "📡", tier: "cross", chain: "cross", unlockedAtStage: 6, isRaw: false },
  { id: "ai_computing", nameKo: "AI컴퓨팅유닛", emoji: "🧠", tier: "cross", chain: "cross", unlockedAtStage: 7, isRaw: false },
  { id: "smart_city", nameKo: "스마트시티모듈", emoji: "🌆", tier: "cross", chain: "cross", unlockedAtStage: 8, isRaw: false },
  { id: "infinite_energy", nameKo: "무한에너지코어", emoji: "♾️", tier: "cross", chain: "cross", unlockedAtStage: 8, isRaw: false },

  { id: "small_factory", nameKo: "소규모공장", emoji: "🏭", tier: "prestige", chain: "prestige", unlockedAtStage: 3, isRaw: false, isPrestigeItem: true },
  { id: "industrial_complex", nameKo: "산업단지", emoji: "🏗️", tier: "prestige", chain: "prestige", unlockedAtStage: 5, isRaw: false, isPrestigeItem: true },
  { id: "future_city", nameKo: "미래도시", emoji: "🌃", tier: "prestige", chain: "prestige", unlockedAtStage: 8, isRaw: false, isPrestigeItem: true }
] as const satisfies readonly ResourceDefinition[];

export type ResourceId = (typeof resources)[number]["id"];

export const resourceById = Object.fromEntries(resources.map((resource) => [resource.id, resource])) as Record<ResourceId, ResourceDefinition>;

export const rawResourceIds = (resources as readonly ResourceDefinition[])
  .filter((resource) => resource.isRaw)
  .map((resource) => resource.id) as ResourceId[];

export const prestigeResourceIds = (resources as readonly ResourceDefinition[])
  .filter((resource) => resource.isPrestigeItem)
  .map((resource) => resource.id) as ResourceId[];